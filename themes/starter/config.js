...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: 'Super Factory: Your Digital Innovation Platform', // 英雄区文字
  STARTER_HERO_TITLE_2: 'Build, Deploy, and Scale Your Digital Solutions', // 英雄区文字
  ...
  STARTER_PRICING_1_FEATURES: 'All themes,Free updates,Documentation', // 英文逗号隔开
  ...
  STARTER_PRICING_2_FEATURES: 'Includes Starter,Source code,Community access,Technical support,SEO optimization', // 英文逗号隔开
  ...
  STARTER_PRICING_3_FEATURES: 'Includes Basic,Custom development', // 英文逗号隔开
  ...
  STARTER_CONTACT_TEXT: 'Tell us what you need',
  STARTER_CONTACT_LOCATION_TITLE: 'Location',
  STARTER_CONTACT_LOCATION_TEXT: 'Fujian, China',
  STARTER_CONTACT_EMAIL_TITLE: 'Get a quote',
  STARTER_CONTACT_EMAIL_TEXT: 'quote@superfactory.net',
