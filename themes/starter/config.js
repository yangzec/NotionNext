...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_TEXT: 'Go Play!', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://docs.tcgpocketpokemon.com/article/vercel-deploy-notion-next', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '更多咨询', // 英雄区按钮
  ...
  STARTER_FEATURE_2_BUTTON_URL:
    'https://docs.tcgpocketpokemon.com/article/notion-next-themes', // 特性2

  STARTER_FEATURE_3_TITLE_1: '优秀的性能', // 特性3
  STARTER_FEATURE_3_TEXT_1: '基于NextJS开发，更快的响应速度，更好的SEO', // 特性3
  STARTER_FEATURE_3_BUTTON_TEXT: '了解更多', // 特性3
  STARTER_FEATURE_3_BUTTON_URL: 'https://docs.tcgpocketpokemon.com/article/next-js', // 特性3

  STARTER_FEATURE_4_TITLE_1: '便捷的写作体验', // 特性4
  STARTER_FEATURE_4_TEXT_1: '只需在Notion笔记中编修，自动同步到网站', // 特性4
  STARTER_FEATURE_4_BUTTON_TEXT: '了解更多', // 特性4
  STARTER_FEATURE_4_BUTTON_URL: 'https://docs.tcgpocketpokemon.com/about', // 特性4
  ...
  STARTER_ABOUT_BUTTON_URL: 'https://docs.tcgpocketpokemon.com/about',
  ...
  STARTER_FAQ_1_ANSWER:
    'NotionNext提供了<a href="https://docs.tcgpocketpokemon.com/about" className="underline">帮助文档</a>，操作<a href="https://www.bilibili.com/video/BV1fM4y1L7Qi/" className="underline">演示视频</a>，以及<a href="https://docs.tcgpocketpokemon.com/article/chat-community" className="underline">交流社群</a>来协助您完成网站的搭建部署',

  STARTER_FAQ_2_QUESTION: '部署后要如何编写文章？',
  STARTER_FAQ_2_ANSWER:
    '您可以在Notion中之间添加或修改类型为Post的页面，内容将被实时同步在站点中，详情参考<a className="underline" href="https://docs.tcgpocketpokemon.com/article/start-to-write">《帮助文档》</a>',
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'mail@tcgpocketpokemon.com',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      ...
      LINK_GROUP: [
        { TITLE: '官方主页', URL: '/#home' },
        { TITLE: '操作文档', URL: 'https://docs.tcgpocketpokemon.com/about' },
        {
          TITLE: '帮助支持',
          URL: 'https://docs.tcgpocketpokemon.com/article/how-to-question'
        },
        {
          TITLE: '合作申请',
          URL: 'https://docs.tcgpocketpokemon.com/article/my-service'
        }
      ]
    },
    {
      ...
      LINK_GROUP: [
        {
          TITLE: '部署指南',
          URL: 'https://docs.tcgpocketpokemon.com/article/vercel-deploy-notion-next'
        },
        {
          TITLE: '升级指南',
          URL: 'https://docs.tcgpocketpokemon.com/article/how-to-update-notionnext'
        },
        { TITLE: '最新版本', URL: 'https://docs.tcgpocketpokemon.com/article/latest' }
      ]
    },
    {
      TITLE: 'Notion写作',
      LINK_GROUP: [
        {
          TITLE: 'Notion开始写作',
          URL: 'https://docs.tcgpocketpokemon.com/article/start-to-write'
        },
        {
          TITLE: '快捷键提升效率',
          URL: 'https://docs.tcgpocketpokemon.com/article/notion-short-key'
        },
        {
          TITLE: '中国大陆使用Notion',
          URL: 'https://docs.tcgpocketpokemon.com/article/notion-faster'
        }
      ]
    }
  ],
  ...
  STARTER_CTA_BUTTON_URL:
    'https://docs.tcgpocketpokemon.com/article/vercel-deploy-notion-next',
  STARTER_CTA_BUTTON_TEXT: '开始体验',

  STARTER_POST_REDIRECT_ENABLE: true, // 默認開啟重定向
  STARTER_POST_REDIRECT_URL: 'https://tcgpocketpokemon.com', // 重定向域名
  STARTER_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_STARTER_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.tcgpocketpokemon.com/article/notion-next-mailchimp
}
