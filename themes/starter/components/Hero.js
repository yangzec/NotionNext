                  ...
                  {siteConfig('STARTER_HERO_BUTTON_2_TEXT', null, CONFIG) && (
                    <li>
                      <a
                        ...
                        target='_blank'
                        className='flex items-center min-w-[130px] rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark'
                        rel='noreferrer'>
                        {siteConfig(
