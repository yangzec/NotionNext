            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <a href="https://docs.tcgpocketpokemon.com" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">技术文档</a>
                            </li>
                            <li className="mb-2">
                                <a href="https://docs.tcgpocketpokemon.com" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">教程指南</a>
                            </li>
                            <li className="mb-2">
                                <a href="https://tcgpocketpokemon.com" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">博客</a>
                            </li>
                            <li className="mb-2">
                                <a href="https://tcgpocketpokemon.com" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">支持中心</a>
                            </li>
                            <li className="mb-2">
